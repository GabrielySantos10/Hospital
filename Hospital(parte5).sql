...
INSERT INTO internação(PACIENTE_ID, DATA_ENTRADA, DATA_PREV_ALTA, DATA_ALTA, PROCEDIMENTO, QUARTO_ID) VALUES("5","10/03/2015", "20/03/2015", "22/03/2015","Endoscopia Digestiva", "1");
INSERT INTO internação(PACIENTE_ID, DATA_ENTRADA, DATA_PREV_ALTA, DATA_ALTA, PROCEDIMENTO, QUARTO_ID) VALUES("5","18/04/2016", "25/04/2016", "23/04/2016","Cirurgia de Apêndice", "4");
INSERT INTO internação(PACIENTE_ID, DATA_ENTRADA, DATA_PREV_ALTA, DATA_ALTA, PROCEDIMENTO, QUARTO_ID) VALUES("20","10/09/2017", "10/10/2017", "10/10/2017", "Artroscopia do Joelho", "2");
INSERT INTO internação(PACIENTE_ID, DATA_ENTRADA, DATA_PREV_ALTA, DATA_ALTA, PROCEDIMENTO, QUARTO_ID) VALUES("17","21/09/2019", "30/09/2019", "28/09/2019", "Cateterismo Cardíaco", "3");
INSERT INTO internação(PACIENTE_ID, DATA_ENTRADA, DATA_PREV_ALTA, DATA_ALTA, PROCEDIMENTO, QUARTO_ID) VALUES("17","28/10/2019", "04/11/2019", "06/11/2019", "Cateterismo Cardíaco", "1");
INSERT INTO internação(PACIENTE_ID, DATA_ENTRADA, DATA_PREV_ALTA, DATA_ALTA, PROCEDIMENTO, QUARTO_ID) VALUES("10","18/12/2020", "30/12/2020", "30/12/2020","Tratamento de Pneumonia", "5");
INSERT INTO internação(PACIENTE_ID, DATA_ENTRADA, DATA_PREV_ALTA, DATA_ALTA, PROCEDIMENTO, QUARTO_ID) VALUES("17","21/08/2021", "03/09/2021", "05/09/2021","Procedimento para tratar insuficiência Cardíaca", "6");

/*Data for the table Tipo_quarto */
INSERT INTO Tipo_Quarto(nome, descrição, VALOR_DIÁRIA) VALUES("Apartamentos", "Um quarto privativo com banheiro exclusivo para o paciente. Geralmente é mais espaçoso e oferece comodidades adicionais, como TV a cabo, ar-condicionado e uma cama de casal. É ideal para pacientes que desejam mais privacidade e conforto durante a estadia no hospital.", "150" );
INSERT INTO Tipo_Quarto(nome, descrição, VALOR_DIÁRIA) VALUES("Quarto_Duplo", "Um quarto compartilhado por dois pacientes, com um banheiro comum. Cada paciente tem sua própria cama e espaço para pertences pessoais. Geralmente é uma opção mais econômica em comparação com o apartamento. É adequado para pacientes que não se importam de compartilhar o espaço com outro paciente.", "120" );
INSERT INTO Tipo_Quarto(nome, descrição, VALOR_DIÁRIA) VALUES("Enfermaria", "Um espaço compartilhado por vários pacientes, com um banheiro comum. Cada paciente tem sua própria cama, mas o quarto é projetado para acomodar um número maior de pacientes. Geralmente é a opção mais econômica e é adequada para pacientes que estão dispostos a compartilhar o espaço com outros.", "100");
...
ALTER TABLE MÉDICO;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 1;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 2;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 3;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 4;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 5;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 6;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 7;
UPDATE MÉDICO SET EM_ATIVIDADE = "Inativo" WHERE MÉDICO_ID = 8;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 9;
UPDATE MÉDICO SET EM_ATIVIDADE = "Inativo" WHERE MÉDICO_ID = 10;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 11;
UPDATE MÉDICO SET EM_ATIVIDADE = "Inativo" WHERE MÉDICO_ID = 12;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 13;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 14;
UPDATE MÉDICO SET EM_ATIVIDADE = "Ativo" WHERE MÉDICO_ID = 15;

-- Valor médio das consultas do ano de 2020 e das que foram feitas sob convênio:
SELECT AVG(VALOR_CONSULTA) AS Media_Consultas_2020
FROM CONSULTA
WHERE YEAR(DATA_CONSULTA) = 2020;

SELECT AVG(VALOR_CONSULTA) AS Media_Consultas_Convenio
FROM CONSULTA
...
INNER JOIN RECEITA ON CONSULTA.CONSULTA_ID = receita.RECEITA_ID
INNER JOIN  PACIENTE ON PACIENTE.PACIENTE_ID = consulta.PACIENTE_ID
ORDER BY  RECEITA.RECEITA_ID LIMIT 1;
...
-- Todos os dados das internações em seus respectivos quartos, calculando o total 
-- da internação a partir do valor de diária do quarto e o número de dias entre a entrada e a alta.
SELECT I.*, Q.TIPO_QUARTO_ID, Q.NÚMERO, (DATEDIFF(STR_TO_DATE(I.DATA_ALTA, '%d/%m/%Y'), 
STR_TO_DATE(I.DATA_ENTRADA, '%d/%m/%Y')) * TQ.VALOR_DIÁRIA) AS TOTAL_INTERNACAO
FROM INTERNAÇÃO I
JOIN QUARTO Q ON I.QUARTO_ID = Q.QUARTO_ID
JOIN TIPO_QUARTO TQ ON Q.TIPO_QUARTO_ID = TQ.TIPO_QUARTO_ID;

-- Data, procedimento e número de quarto de internações em quartos do tipo "apartamento":
SELECT I.DATA_ENTRADA, I.PROCEDIMENTO, Q.NÚMERO
FROM INTERNAÇÃO I
JOIN QUARTO Q ON I.QUARTO_ID = Q.QUARTO_ID
JOIN TIPO_QUARTO TQ ON Q.TIPO_QUARTO_ID = TQ.TIPO_QUARTO_ID
WHERE TQ.NOME = 'apartamento';

-- Nome do paciente, data da consulta e especialidade de todas as consultas em que os pacientes eram menores de 18
-- anos na data da consulta e cuja especialidade não seja "pediatria", ordenando por data de realização da consulta:
SELECT P.NOME AS Nome_Paciente, C.DATA_CONSULTA, NOME_ESPECIALIDADE AS Especialidade
FROM CONSULTA C
JOIN PACIENTE P ON C.PACIENTE_ID = P.PACIENTE_ID
JOIN ESPECIALIDADE E ON C.ESPECIALIDADE_ID = E.ESPECIALIDADE_ID
WHERE DATEDIFF(CURRENT_DATE(), STR_TO_DATE(P.DATA_NASCIMENTO, '%d/%m/%Y')) < 6570 -- Menor de 18 anos
AND NOME_ESPECIALIDADE != 'pediatria'
ORDER BY C.DATA_CONSULTA;

-- Nome do paciente, nome do médico, data da internação e procedimentos das internações realizadas por médicos da 
-- especialidade "gastroenterologia", que tenham acontecido em "enfermaria":
SELECT P.NOME AS Nome_Paciente, M.NOME AS Nome_Médico, I.DATA_ENTRADA, I.PROCEDIMENTO
FROM INTERNAÇÃO I
JOIN PACIENTE P ON I.PACIENTE_ID = P.PACIENTE_ID
JOIN MÉDICO M ON MÉDICO_ID = M.MÉDICO_ID
JOIN ESPECIALIDADE E ON M.ESPECIALIDADE_ID = E.ESPECIALIDADE_ID
JOIN QUARTO Q ON I.QUARTO_ID = Q.QUARTO_ID
JOIN TIPO_QUARTO TQ ON Q.TIPO_QUARTO_ID = TQ.TIPO_QUARTO_ID
WHERE NOME_ESPECIALIDADE = 'gastroenterologia' AND TQ.NOME = 'enfermaria';

-- Os nomes dos médicos, seus CRMs e a quantidade de consultas que cada um realizou:
SELECT M.NOME AS Nome_Médico, M.CRM, COUNT(C.CONSULTA_ID) AS Quantidade_Consultas
FROM MÉDICO M
JOIN CONSULTA C ON M.MÉDICO_ID = C.MÉDICO_ID
...
SELECT E.NOME AS Nome_Enfermeiro, E.CRE, COUNT(I.INTERNAÇÃO_ID) AS Quantidade_Internações
FROM ENFERMEIRO E
JOIN INTERNAÇÃO I ON E.ENFERMEIRO_ID = ENFERMEIRO_ID
GROUP BY E.NOME, E.CRE
HAVING COUNT(I.INTERNAÇÃO_ID) > 1;
